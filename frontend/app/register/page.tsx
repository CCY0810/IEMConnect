...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-br from-indigo-500 bg-opacity-10 to-blue-500 bg-opacity-10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-br from-blue-500 bg-opacity-8 to-cyan-500 bg-opacity-8 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="relative z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 order-2 lg:order-1">
          ...
          <div className="flex items-center space-x-6 mb-8">
            <div className="p-4 bg-slate-800 bg-opacity-90 backdrop-blur-md rounded-3xl shadow-2xl border border-slate-700 hover:shadow-indigo-500/20 hover:scale-105 transition-all duration-300">
              <img
                src="/iem-logo.jpg"
                alt="IEM Logo"
          ...
          <div className="lg:hidden flex justify-center mt-8">
            <div className="p-3 bg-slate-800 bg-opacity-90 backdrop-blur-md rounded-2xl shadow-xl border border-slate-700">
              <img
                src="/iem-logo.jpg"
                alt="IEM Logo"
        ...
        <div className="flex justify-center items-center order-1 lg:order-2">
          <div className="w-full max-w-md">
            <div className="bg-slate-800 bg-opacity-90 backdrop-blur-xl border border-slate-700 rounded-3xl shadow-2xl shadow-indigo-500/20 p-8 sm:p-10 lg:p-12 hover:shadow-indigo-500/30 hover:scale-105 transition-all duration-300">
              ...
              <div className="mt-8 pt-6 border-t border-slate-600 border-opacity-60">
