  ...
  return (
    ...
    <div className="flex min-h-screen bg-slate-900 text-slate-100">
      ...
      >
        ...
        <nav className="px-3 py-6 space-y-2flex-1 overflow-y-auto">
          <SidebarButton
...
function SidebarButton({ icon, label, open, active, onClick }: any) {
  const baseClasses =
    "w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors duration-150 font-medium";
