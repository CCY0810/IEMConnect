...
const buttonVariants = (props)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])(baseStyles, variants[variant], sizes[size]);
};
...
function Skeleton({ className, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("animate-pulse rounded-md bg-slate-200", className),
        ...props
    }, void 0, false, {
...
"[project]/frontend/lib/reports-api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getUsersInsights = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/users-insights");
    return res.data;
};
const getEventOperations = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/event-operations");
    return res.data;
};
const getAttendanceEngagement = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/attendance-engagement");
    return res.data;
};
const getAttendanceByFaculty = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/attendance-by-faculty");
    return res.data.attendance_by_faculty;
};
const getRegistrationsVsAttendance = async (months = 6)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/registrations-vs-attendance", {
        params: {
            months
        }
    });
...
const getRecentActivity = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/recent-activity");
    return res.data.recent_activity;
};
const getTopEvents = async ()=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/reports/top-events");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/reports-api.ts [app-ssr] (ecmascript)");
...
function DashboardPage() {
    ...
    // Analytics state
    const [usersInsights, setUsersInsights] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [eventOps, setEventOps] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [topEvents, setTopEvents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        const loadKPIs = async ()=>{
            try {
                const [ui, eo, ae] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUsersInsights"])(),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getEventOperations"])(),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAttendanceEngagement"])()
                ]);
                setUsersInsights(ui);
                setEventOps(eo);
                setEngagement(ae);
        ...
        const loadCharts = async ()=>{
            try {
                const [af, tr] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAttendanceByFaculty"])(),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRegistrationsVsAttendance"])(6)
                ]);
                setFacultyData(Object.entries(af).map(([name, value])=>({
                        name,
                        value
                    })));
                setTrendData(tr);
        ...
        const loadTables = async ()=>{
            try {
                const [ra, te] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRecentActivity"])(),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$reports$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTopEvents"])()
                ]);
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                onClick: ()=>{
                                                                    if (!showApprovalPanel) toggleApprovalPanel();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0854865e._.js.map