...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            const loadKPIs = {
                "DashboardPage.useEffect.loadKPIs": async ()=>{
                    try {
                        ...
                        setEngagement(ae);
                        setLoadingStates({
                            "DashboardPage.useEffect.loadKPIs": (prev)=>({
                                    ...prev,
                                    kpis: false
                                })
                        }["DashboardPage.useEffect.loadKPIs"]);
                    } catch (err) {
            ...
            const loadCharts = {
                "DashboardPage.useEffect.loadCharts": async ()=>{
                    try {
                        ...
                        setFacultyData(Object.entries(af).map({
                            "DashboardPage.useEffect.loadCharts": ([name, value])=>({
                                    name,
                                    value
                                })
                        }["DashboardPage.useEffect.loadCharts"]));
                        setTrendData(tr);
                        setLoadingStates({
                            "DashboardPage.useEffect.loadCharts": (prev)=>({
                                    ...prev,
                                    charts: false
                                })
                        }["DashboardPage.useEffect.loadCharts"]);
            ...
            // Load tables last
            const loadTables = {
                "DashboardPage.useEffect.loadTables": async ()=>{
                    try {
                        ...
                        setTopEvents(te);
                        setLoadingStates({
                            "DashboardPage.useEffect.loadTables": (prev)=>({
                                    ...prev,
                                    tables: false
                                })
                        }["DashboardPage.useEffect.loadTables"]);
                    } catch (err) {
            ...
            setTimeout({
                "DashboardPage.useEffect": ()=>loadCharts()
            }["DashboardPage.useEffect"], 100);
            setTimeout({
                "DashboardPage.useEffect": ()=>loadTables()
            }["DashboardPage.useEffect"], 200);
...
_s(DashboardPage, "QKgZ5TtBgvdgedQfwXscGKEqitg=", false, function() {
    return [
...
//# sourceMappingURL=frontend_e79c1957._.js.map